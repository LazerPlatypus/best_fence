...
use <coord_kit/core.scad>;
include <../config.scad>;
use <bolt.scad>;
use <toe_clamp_insert.scad>;

// Module: toe_clamp_body
// Description: A simple toe clamp for holding the Best Fence, used by the {{mount}}
//   This module creates a simple toe clamp body that takes the {{toe_clamp_insert}} and a bolt as children
